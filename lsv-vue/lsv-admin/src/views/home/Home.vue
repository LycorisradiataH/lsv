<template>
  <div>
    ...
    <el-row :gutter="30">
      <el-col :span="6">
        <el-card>
          ...
          <div class="card-desc">
            ...
            <div class="card-count">{{ viewCounts }}</div>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
      ...
      <el-col :span="6">
        <el-card>
          ...
          <div class="card-desc">
            <div class="card-title">视频量</div>
            <div class="card-count">{{ videoCount }}</div>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
    ...
    <el-row :gutter="20" style="margin-top: 1.25rem">
      ...
      <el-col :span="16">
        <el-card>
          <div class="e-title">视频浏览量排行</div>
          <div style="height: 350px">
            <v-chart :options="videoRank" v-loading="loading" />
          </div>
        </el-card>
      </el-col>
      <!-- 分类数据统计 -->
  ...
  methods: {
    getData() {
      this.axios.get("/api/admin").then(({ data }) => {
        this.viewCounts = data.data.viewCount;
        ...
        if (data.data.videoBackRankDTOList != null) {
          data.data.videoBackRankDTOList.forEach((item) => {
            this.videoRank.series[0].data.push(item.viewCount);
            this.videoRank.xAxis.data.push(item.videoName);
          });
        }
